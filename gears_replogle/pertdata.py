...
class PertData:
    ...
    def load(self, data_name=None,
        ...
        if data_name in ['norman', 'adamson', 'dixit',
            ...
            print(f"self.adata.shape is {self.adata.shape}")
            print(f"de genes numbers is {len(self.adata.uns['non_zeros_gene_idx'])}")
            print(f"condition type numbers is {len(set(self.adata.obs.condition))}")
