...
parser.add_argument("--results_path", type=str, default= "results/replogle_rpe1_essential_linear_results/all_predictions.json", required = True, help = "the path of linear model results.")
