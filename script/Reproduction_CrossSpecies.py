...
parser.add_argument("--dataset_name", type=str, default='mouse_115746',help='mouse_115746/mouse_10x/mouse_smart/elegans/MergedMonkey')
parser.add_argument("--model_path", type=str, default='../checkpoint/cross_species',help='the folder of checkpoint')
parser.add_argument("--data_path", type=str, default='../data/cross_species',help='the folder of data')
...
hyperparameter_defaults = dict(
    ...
    load_model=args.model_path+f"/{model_name}/{args.peft_type}",
    mask_ratio=0.0,
    n_bins=51,
