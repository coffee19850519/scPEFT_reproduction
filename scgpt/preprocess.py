...
class TFPreprocessor:
    ...
    def __init__(
        ...
        self.append_TFs = True if FT_genes is not None else False
    ...
    def __call__(self, adata: AnnData, batch_key: Optional[str] = None) -> Dict:
        ...
        # Copy adata before binning for append TFs
        complete_adata = adata.copy()
        ...
        # step 6.1: append TF PriorMarkers
