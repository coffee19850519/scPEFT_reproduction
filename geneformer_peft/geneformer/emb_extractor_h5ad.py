...
def mean_nonpadding_embs(embs, original_lens):
    ...
    attention_mask = mask.type(torch.long)
...
def get_embs(model,
    ...
    for i in trange(0, total_batch_length, forward_batch_size):
        ...
        input_data_minibatch = pad_tensor_list(input_data_minibatch,
                                               ...
                                               pad_token_id,
                                               model_input_size)
        attention_mask = torch.ones_like(input_data_minibatch)
...
class EmbExtractor:
    ...
    def extract_embs(self,
        ...
        filtered_input_data = load_and_filter_no_shuffled(self.filter_data, self.nproc, input_data_file)
