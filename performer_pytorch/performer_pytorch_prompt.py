...
class Gene2VecPositionalEmbedding(nn.Module):
    def __init__(self, dim, max_seq_len):
        super().__init__()
        gene2vec_weight = np.load('/media/fei/Data/frx/scPEFT_reproduction/performer_pytorch/gene2vec_16906.npy')
...
class Performer(nn.Module):
    def __init__(
        ...
        self.net = execute_type(layers, args_route={**attn_route_map, **context_route_map},
                                prompt_type=self.prompt_type, Encoder_Space=self.Encoder_Space,
                                Encoder_MLP=self.Encoder_MLP, dim=dim)
